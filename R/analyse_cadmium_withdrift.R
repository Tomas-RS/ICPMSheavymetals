#' Third and last step in ICP-MS R analysis for cadmium_111 when adjusting for drift.
#'
...
#' e.g. analyse_cadmium_withdrift3(Cadmium_analysis, "1 ppb standard", "0.0004 ppb metal standard", "0.002 ppb metal standard",
...
analyse_cadmium_withdrift3 <- function(a,b,c,d,e,f,g,h,i,j){
  ...
  a$Z03_Cd_driftadjust <- a$Z02_Inadjust - coef(Cadmium_driftplot)[2] *
    (a$Sequence_position - Cadmium_standards[1,1])
  ...
  a$Z04_Cd_blankadjust <- a$Z03_Cd_driftadjust - mean(Cadmium_blanks[["Z03_Cd_driftadjust"]])
