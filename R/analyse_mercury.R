#' Third and last step in ICP-MS R analysis for mercury_202 without adjusting for drift.
#'
...
#' e.g. analyse_mercury3(Mercury_analyis, "1 ppb standard", "0.0004 ppb metal standard", "0.002 ppb metal standard",
...
analyse_mercury3 <- function(a,b,c,d,e,f,g,h,i,j){
  ...
  plot(Mercury_blanks$Sequence_position, Mercury_blanks$Z02_Iradjust,
       main="Trend of blank values", xlab = "Sequence position", ylab = "Signal (Hg)")

  a$Z04_Hg_blankadjust <- a$Z02_Iradjust - mean(Mercury_blanks[["Z02_Iradjust"]])
