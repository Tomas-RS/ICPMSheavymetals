#' Third and last step in ICP-MS R analysis for lead_208 without adjusting for drift.
#'
...
#' e.g. analyse_lead3(Lead_analyis, "1 ppb standard", "0.0004 ppb metal standard", "0.002 ppb metal standard",
...
analyse_lead3 <- function(a,b,c,d,e,f,g,h,i,j){
  ...
  plot(Lead_blanks$Sequence_position, Lead_blanks$Z02_Iradjust,
       main="Trend of blank values", xlab = "Sequence position", ylab = "Signal (Pb)")

  a$Z04_Pb_blankadjust <- a$Z02_Iradjust - mean(Lead_blanks[["Z02_Iradjust"]])
